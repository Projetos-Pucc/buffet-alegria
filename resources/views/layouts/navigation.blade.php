            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  @unlessrole('user')
                    ...
                    @role('administrative')
                      <a href="{{ route('survey.index') }}" class="{{ request()->routeIs('survey.index') ? 'bg-amber-500 text-black' : 'text-black-300 hover:bg-amber-300 hover:text-black' }} rounded-md px-3 py-2 text-sm font-medium" aria-current="{{ request()->routeIs('survey') ? 'page' : '' }}">{{ __('Pesquisa de satisfação') }}</a>
                    @endrole
                  @endunlessrole
